...
//
//     final premierLeagueModel = premierLeagueModelFromJson(jsonString);

import 'dart:convert';

PremierLeagueModel premierLeagueModelFromJson(String str) => PremierLeagueModel.fromJson(json.decode(str));

String premierLeagueModelToJson(PremierLeagueModel data) => json.encode(data.toJson());
...
class PremierLeagueModel {
    ...
    factory PremierLeagueModel.fromJson(Map<String, dynamic> json) => PremierLeagueModel(
